...
<p id='top'><a href='#bottom'>Scroll to bottom</a></p>
      ...
      <p style="text-align: center;"><span style="color: rgba(0, 0, 0, 0.95);">middleposition</span></p>
      <p style="text-align: right;"><span style="color: rgba(0, 0, 0, 0.95);">endingposition</span></p>
      <p style="text-align: justify;"><span style="color: rgba(0, 0, 0, 0.95);">startingposition</span></p>
      <p style="text-align: center;"><span style="color: rgba(0, 0, 0, 0.95);">againmiddleposition</span></p>
...
// import 'package:session1/home_page.dart';
// import 'package:session1/html_rendering_page.dart';
// import 'package:session1/list_view_page.dart';
// import 'package:session1/navigation_bottom_page.dart';
// import 'package:session1/new_desisgn.dart';
// import 'package:session1/new_html.dart';
// import 'package:session1/stack_sample.dart';
// import 'package:session1/text_page.dart';
...
//   final List<Widget> _Pages = [AlertPage(), HomePage(), ListViewPage()];
//
//   @override
//   void dispose() {
